...
//
    ...
    @IBDesignable open class TSCButton: UIButton {
        ...
        #if os(tvOS)
        @IBInspectable open var primaryFocusedColor: UIColor {
            didSet {
                updateButtonColours()
            }
        }
        
        @IBInspectable open var secondaryFocusedColor: UIColor {
            didSet {
                updateButtonColours()
            }
        }
        ...
        required public init?(coder aDecoder: NSCoder) {
            ...
            #if os(tvOS)
            primaryFocusedColor = UIColor.blue
            secondaryFocusedColor = UIColor.white
            #endif
        ...
        private func updateButtonColours() {
            ...
            #if os(tvOS)
            let primary = isFocused ? primaryFocusedColor : primaryColor
            let secondary = isFocused ? secondaryFocusedColor : secondaryColor
            #else
            ...
            //Default state
            layer.borderColor = useBorderColor ? borderColor?.cgColor : primary.cgColor
            
            if solidMode == true {
                
                layer.backgroundColor = primary.cgColor
                setTitleColor(secondary, for: [])
